...
int main() {
  ...
  while (getline(in_map_, line)) {
	...
	int lane = 1;
	double velocity=0;
  h.onMessage([&velocity,&lane,&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
                     uWS::OpCode opCode) {
